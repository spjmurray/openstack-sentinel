...
OPTS = [
    ...
    cfg.ListOpt('volume_volume',
                item_type=types.String(),
                default=['attachments', 'id', 'size', 'user_id', 'status', 'name',
                         'os-vol-tenant-attr:tenant_id'],
                help='List of fields to return for volume resources from the volume service'),
    cfg.ListOpt('image_image',
                item_type=types.String(),
                default=['checksum', 'container_format', 'created_at', 'disk_format',
                         'id', 'min_disk', 'min_ram', 'name', 'owner', 'protected',
                         'size', 'status', 'updated_at', 'virtual_size', 'visibility'],
                help='List of fields to return for image resources from image service'),
